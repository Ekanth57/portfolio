  ...
  Widget _buildSocialButton(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: FaIcon(icon, color: color, size: isSmallScreen ? 20 : 24),
      ),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          overflow:
                              isSmallScreen ? TextOverflow.ellipsis : null,
                        ),
                        const SizedBox(height: 20),
                        Text(
                          'Technologies Used:',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Container(
                  height: 6,
                  decoration: BoxDecoration(
                    color: skillData.color.withOpacity(0.2),
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        skillData.color,
                        skillData.color.withOpacity(0.7),
                      ],
                    ),
                    borderRadius: BorderRadius.circular(3),
                  ),
            ...
            const SizedBox(height: 8),
            Text(
              '${(skillData.proficiency * 100).toInt()}%',
              style: GoogleFonts.poppins(
                fontSize: 12,
                fontWeight: FontWeight.w500,
                color: skillData.color,
...
class ContactSection extends StatelessWidget {
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              return SlideInUp(
                ...
                child: _buildContactCard(context, contactItems[index]),
              );
            },
          ),
          const SizedBox(height: 40),
  ...
  Widget _buildContactCard(BuildContext context, ContactItem item) {
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: GlassmorphicContainer(
            width: double.infinity,
            height: MediaQuery.of(context).size.width < 600 ? 120 : 140,
            borderRadius: MediaQuery.of(context).size.width < 600 ? 16 : 20,
          blur: 20,
          alignment: Alignment.center,
          border: 2,
          linearGradient: LinearGradient(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: MediaQuery.of(context).size.width < 600 ? 2 : 4,
                ),
                Text(
                  item.subtitle,
                  style: GoogleFonts.poppins(
